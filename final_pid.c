...
int login(){
    ...
    while(username!="krish" || pass!=pwd)
    {
    value=strcmp(username,"krish");
...
int administrationpage(){
    printf("\n\n****************************************************\n\n");
    printf("      WELCOME TO ADMINISTRATION PAGE        \n\n");
    printf("****************************************************\n\n");
...
int search_rec(){
int find;
        printf("\nEnter the Serial number to find the data:");
        scanf("%d",&find);
